...
register_parser.add_argument('pfp_base64', type=max_length(((config.MAX_IMAGE_SIZE * 4) / 3),
                                                           help_str="pfp_base64"))
...
patch_user_parser.add_argument('pfp_base64', type=max_length(((config.MAX_IMAGE_SIZE * 4) / 3),
                                                             help_str="pfp_base64"))
